...
- [ ] Explain what a token is used for.
  - A Token is used to Authenticate the user and allow users to private routes
- [ ] What steps can you take in your web apps to keep your data secure?
  - Using HTTPS on your site in one way to secure your site. Putting all your data on a backend server is a good way to protect your data.
- [ ] Describe how web servers work.
  - web servers allow the browers to access files.
